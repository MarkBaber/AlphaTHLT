...
def main():
    ...
    for jobNum in range(1, jobs + 1):
        ...
        tempCfgText = tempCfgText.replace("fileName = cms.untracked.string('file:hltReRunResults.root'),", "fileName = cms.untracked.string('" + outputROOTName + "'),")


        # Create the configuration file and batchshell script for the job
        batchCfgFile = outputDir + "/ReRunHLT"   + "_" + str(jobNum) + ".py"
        ...
        tempShText  =     ""
        tempShText +=     "#!/bin/bash\n\n"
        tempShText +=     "export X509_USER_PROXY=/home/hep/mb1512/myproxy\n";
        ...
        tempShText +=     "export CMSSW_PROJECT_SRC=\"SUSY/UCTHLT/CMSSW_7_2_0_pre8/src\"\n"
