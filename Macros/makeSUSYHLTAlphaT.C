...
void makeSUSYHLTAlphaT(){
  ...
  // ------------------------------------------------------------------------------------------------------------------------
  sample selectedSample = T2tt_500_250; //TTBar; //NuGun; //QCD30to50;  //test; //QCD30to50; // T2tt_500_250; //T2cc_250_210; //DYJets; //NuGun; //DYJets; //TTBar; //DYJets;
  ...
  for (uint iPath = 0; iPath < hltPathNames.size(); ++iPath){
    ...
    hist1DRate["L1HTT"]       = new TH1D("L1HTT",       "L1HTT;H_{T} (GeV);Fired",         220, 0, 220);
    hist1DRate["L1SingleJet"] = new TH1D("L1SingleJet", "L1 Single jet;p_{T} (GeV);Fired", 220, 0, 220);
    hist1DRate["L1DoubleJet"] = new TH1D("L1DoubleJet", "L1 Double jet;p_{T} (GeV);Fired", 220, 0, 220);
    hist1DRate["L1QuadJet"]   = new TH1D("L1QuadJet",   "L1 Quad jet;p_{T} (GeV);Fired",   220, 0, 220);
  ...
  // ------------------------------------------------------------ 
    ...
    // rateChain->SetBranchAddress("HLT_PFHT900_v1",                       &HLT_PFHT900_v1);
    // rateChain->SetBranchAddress("HLT_PFHT350_PFMET120_NoiseCleaned_v1", &HLT_PFHT350_PFMET120_NoiseCleaned_v1 );
    // rateChain->SetBranchAddress("HLT_HT200_AlphaT0p4_v1",               &HLT_HT200_AlphaT0p4_v1 );
    // rateChain->SetBranchAddress("HLT_HT200_PFAlphaT0p4_v1",             &HLT_HT200_PFAlphaT0p4_v1 );
  ...
  for ( unsigned int iEvent = nuEventLow; iEvent < nuEventHigh; ++iEvent ){
    ...
    // std::cout << HLT_PFHT900_v1 << "\t" << HLT_PFHT350_PFMET120_NoiseCleaned_v1 << "\t" << HLT_HT200_AlphaT0p4_v1 
    // 	      << "\t" << HLT_HT200_PFAlphaT0p4_v1 << "\n";
    ...
    // histHLTRate["HLT_PFHT900_v1"]                      ->Fill( HLT_PFHT900_v1 );
    // histHLTRate["HLT_PFHT350_PFMET120_NoiseCleaned_v1"]->Fill( HLT_PFHT350_PFMET120_NoiseCleaned_v1 );
    // histHLTRate["HLT_HT200_AlphaT0p4_v1"]              ->Fill( HLT_HT200_AlphaT0p4_v1 );
    // histHLTRate["HLT_HT200_PFAlphaT0p4_v1"]            ->Fill( HLT_HT200_PFAlphaT0p4_v1 );

    // if ( uctHT >= 200. ){
    //   histHLTRate["HLT_PFHT900_v1_AND_HTT200"]           ->Fill( HLT_PFHT900_v1 );
    // }
